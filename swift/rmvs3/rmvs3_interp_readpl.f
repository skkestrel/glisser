...
c Last revision: 
      ...
      subroutine rmvs3_interp_readpl(nbod,xbeg,ybeg,zbeg,vxbeg,vybeg,
...
c         if(iflg.ne.0) then
c            write(*,*) ' Planet ',i,' is lost in rmvs2_interp !!!!!!!!!'
c            write(*,*) msun,dtb
c            write(*,*) xc2(i),yc2(i),zc2(i)
c            write(*,*) vxc2(i),vyc2(i),vzc2(i)
c            write(*,*) ' STOPPING '
c            call util_exit(1)
c         endif
...
c            if(iflg.ne.0) then
c               write(*,*) ' Planet ',i,' is lost in rmvs2_interp_o !!!'
c               write(*,*) msun,dtb
c               write(*,*) xc1(i),yc1(i),zc1(i)
c               write(*,*) vxc1(i),vyc1(i),vzc1(i)
c               write(*,*) ' STOPPING '
c               call util_exit(1)
c            endif
