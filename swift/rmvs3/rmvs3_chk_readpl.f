...
c Last revision: 
      ...
      subroutine rmvs3_chk_readpl(nbod,ntp,mass,xh,yh,zh,vxh,
     &       vyh,vzh,xht,yht,
...
c...  Internals
       ...
       integer i1sthill    ! =0 first time through; =1 after
c       data i1st/0/
...
c     KZ calc hill sphere with r instead of a
        if(i1sthill.eq.0) then
           call util_hills_r(nbod,mass,xh,yh,zh,vxh,vyh,vzh,r2hill)
           i1sthill = 1
        endif
