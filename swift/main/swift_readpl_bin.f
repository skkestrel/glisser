...
c Initializes the a0 array
	   ...
	   do ip=2,nbod
	      rn = rn + 1
	      read (77, rec=rn) ipl, rms(ipl), a0(ipl), e0(ipl),
     $           ri0(ipl), omega0(ipl), capom0(ipl), capm0(ipl)
	      mass(ip)=rms(ipl)
	      a=a0(ipl)
	      e=e0(ipl)
	      inc=ri0(ipl)
...
c	   write(*,*)'dt=',dt
	   ...
	   do ipt=2,nbod
	      rn = rn + 1
	      read (77, rec=rn) ipl, rms(ipl), a1(ipl), e1(ipl),
     $           ri1(ipl), omega1(ipl), capom1(ipl), capm1(ipl)
