...
filename1 = "discard_opio_UNR.out"
filename2 = "discard_mercury_UNR.out"
...
for file,label in zip(files,["GLISSER on opio", "MERCURY on avignon"]):
...
ax.legend()
plt.savefig("discard_UNR.jpg",dpi=150)