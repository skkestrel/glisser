...
def plotHistRes(target_pa, target_pl, outputEnc):
    ...
    plt.savefig("particle_{idx:d}_RESO.jpg".format(idx=target_pa), dpi=200)
    plt.savefig("particle_{idx:d}_RESO.pdf".format(idx=target_pa), dpi=200)
